...
class _MyHomePageState extends State<MyHomePage> {
  List<Results> items = People.fromJson(jsonDecode(
  ...
  List<Planets> items2 = PlanetResponse.fromJson(jsonDecode(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(children: [
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Card(
                  elevation: 4,
                  margin: EdgeInsets.fromLTRB(0.0, 0.0, 12.0, 36.0),
                  color: Colors.yellow,
                  child: SizedBox(
            ...
            itemBuilder: (context, index) {
              return Card(
                  ...
                  child: SizedBox(
                    ...
                    Padding(
                        padding: const EdgeInsets.all(10.0),
                        child: Text(items2.elementAt(index).name.toUpperCase(),
                            style: const TextStyle(
        ...
        Text("Stars Wars", style: TextStyle(fontSize: 80))
      ]),
    );
  }
}
